...
public class FansActivity extends AppCompatActivity implements Config {
    ...
    public void create(View view) {
        ...
        if(user1.isEmpty() || email1.isEmpty() || fname1.isEmpty() || lname1.isEmpty()) {
            Toast.makeText(FansActivity.this, "Fields cannot be blank", Toast.LENGTH_SHORT).show();  // Check whether the fields are not blank
        }
        else {
            // Create various messages to display in the app.
            Toast failed_toast = Toast.makeText(FansActivity.this, "Request failed", Toast.LENGTH_SHORT);
            Toast created_toast = Toast.makeText(FansActivity.this, "User created", Toast.LENGTH_SHORT);
    ...
    public void user(View view) {
        Intent user = new Intent(FansActivity.this, FanProfileActivity.class);
        startActivity(user);
    }
}
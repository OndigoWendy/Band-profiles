...
public class FanProfileActivity extends AppCompatActivity {
    ...
    public void fetch(View view) {
        ...
        Toast failed_toast = Toast.makeText(FanProfileActivity.this, "Request failed", Toast.LENGTH_SHORT);
        Toast fetched_toast = Toast.makeText(FanProfileActivity.this, "Data Fetched", Toast.LENGTH_SHORT);
                            ...
                            for (int i=0; i < array.length(); i++) {
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        TableRow tr = new TableRow(FanProfileActivity.this);
    ...
    public void createTextView(String text, TableRow tr) {
        TextView t = new TextView(FanProfileActivity.this);
        t.setText(text);
